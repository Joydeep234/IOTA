    ...
    <div className="servicemaincontainer">
      ...
      <div className="webdev">
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Portfolio Website" }}>
            <h4 className="servicetitle">Portfolio Website</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Personal website" }}>
            <h4 className="servicetitle">Personal website</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Portfolio" }}>
            <h4 className="servicetitle">Portfolio</h4>
          </Link>
          <img
            src="https://assets.materialup.com/uploads/28a542c8-abfb-48c5-9301-3efd837518d6/preview.jpg"
            alt=""
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Blogs" }}>
            <h4 className="servicetitle">Blogs</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Bussiness Website" }}>
            <h4 className="servicetitle">Bussiness Website</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Ecommerce website" }}>
            <h4 className="servicetitle">Ecommerce website</h4>
          </Link>
          <img
      ...
      <div className="graphics">
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Web Design" }}>
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "UI and UX Design" }}>
            <h4 className="servicetitle">UI and UX Design</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link
            to={"/contact"}
            state={{ data: "Motion Graphics and Animation" }}
          >
            <h4 className="servicetitle">Motion Graphics and Animation</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link
            to={"/contact"}
            state={{ data: "Advertizing and Market Designing" }}
          >
            <h4 className="servicetitle">Advertizing and Market Designing</h4>
          </Link>
          <img
      ...
      <div className="mobile">
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "native" }}>
            <h4 className="servicetitle">native</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Cross Platform" }}>
            <h4 className="servicetitle">Cross Platform</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "hybrid" }}>
            <h4 className="servicetitle">hybrid</h4>
          </Link>
          <img
      ...
      <div className="photo">
        <h3>PhotoGrapgy</h3>
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Landscape" }}>
            <h4 className="servicetitle">Landscape</h4>
          </Link>
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Wedding" }}>
            <h4 className="servicetitle">Wedding</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Fashion" }}>
            <h4 className="servicetitle">Fashion</h4>
          </Link>
          <img
        ...
        <div className="descandimg">
          <Link to={"/contact"} state={{ data: "Documentry" }}>
            <h4 className="servicetitle">Documentry</h4>
          </Link>
          <img
